...
export function registerComponentHook(componentId, type, // hook type, could be "lifecycle" or "instance"
hook, // hook name
fn) {
...
export function updateComponentData(componentId, newData, callback) {
  if (!document || !document.taskCenter) {
    warn(`Can't find available "document" or "taskCenter".`);
    return;
  }
