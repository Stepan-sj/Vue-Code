...
export function genAttrSegments(attrs) {
  return attrs.map(({ name, value }) => genAttrSegment(name, value));
}

export function genDOMPropSegments(props, attrs) {
  const segments = [];
...
export function genClassSegments(staticClass, classBinding) {
...
export function genStyleSegments(staticStyle, parsedStaticStyle, styleBinding, vShowExpression) {
